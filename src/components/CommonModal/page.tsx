...
export default function CommonModal({modalTitle,mainContent,showButtons,buttonComponent,show,setShow,showModalTitle}) {
    ...
    <Transition.Root show={show} as={Fragment}>
      <Dialog as="div" className={'relative z-10'} onClose={setShow}>
        <Transition.Child as={Fragment} enter="ease-in-out duration" enterFrom="opacity-0" enterTo="opacity-100"
        ...
        leave="ease-in-out duration-500" leaveFrom="opacity-100" leaveTo="opacity-0">
                   <Dialog.Panel className={'w-screen max-w-md'}>
                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                        ...
                        {
                            showButtons ? <div className="border-t border-gray-300 px-4 py-6
                            sm:px-6">{buttonComponent}</div>: null
                        }
                    </div>
                   </Dialog.Panel>
                  </Transition.Child>
